...
tldr: "本研究提出MR-Search，一种结合自我反思的上下文元强化学习框架，旨在优化智能体搜索任务。不同于传统单回合稀疏奖励优化，MR-Search通过总结过去回合的经验生成显式自我反思，并将其作为上下文引导后续探索。此外，引入多轮RL算法实现细粒度信用分配。实验表明，该方法在八个基准测试中比传统RL提升了9.2%至19.3%，显著增强了测试时的探索与适应能力。"
selection_source: fresh_fetch
motivation: 传统强化学习在处理搜索任务时，往往受限于单回合独立优化和稀疏奖励，缺乏跨回合的策略调整能力。
method: 提出MR-Search框架，利用跨回合的自我反思作为上下文信息，并结合多轮RL算法进行细粒度的信用分配。
result: "在八项基准测试中，MR-Search相比现有强化学习基准实现了9.2%到19.3%的性能提升，并表现出极强的泛化性。"
conclusion: 通过将自我反思融入元强化学习，智能体能够有效实现上下文内的策略进化，显著提升复杂搜索任务的成功率。
---
